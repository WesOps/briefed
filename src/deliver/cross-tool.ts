 ...
 */
export function writeCursorRules(root: string, skeleton: string) {
 ...
 */
export function writeAgentsMd(root: string, skeleton: string) {
 ...
 */
export function writeCopilotInstructions(root: string, skeleton: string) {
 ...
 */
export function writeCodexMd(root: string, skeleton: string) {
  const content = `# Project Context (generated by briefed)
