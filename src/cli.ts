...
program
  ...
  .option("--timeout <seconds>", "Per-task claude -p timeout", (v) => parseInt(v, 10), 1800)
  .option("--setup-timeout <seconds>", "Adapter setup timeout (e.g. briefed init --deep); defaults to --timeout", (v) => parseInt(v, 10))
