...
Files: 62 source files across 7 directories

## src/extract/ (31 files)
signatures.ts ★13
  ...
  interface FileExtraction — Import reference found in a file. [10 callers]
...
<!-- briefed skeleton: 35 files, ~1717 tokens -->
